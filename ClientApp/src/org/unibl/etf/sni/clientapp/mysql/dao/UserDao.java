package org.unibl.etf.sni.clientapp.mysql.dao;
...
public class UserDao {
	...
	private static final String SQL_SELECT_USERNAME="SELECT username from user where username like ?";
	...
	public static List<String> getAllUsername(String query) {
		PreparedStatement ps = null;
		Connection c = null;
		String tmp="%";
		...
		try {
			c = ConnectionPool.getInstance().checkOut();
			Object pom[] = { tmp};
			ps = ConnectionPool.prepareStatement(c,SQL_SELECT_USERNAME,false, pom);
			rs = ps.executeQuery();
			while (rs.next()) {
